...
var nodes = [{ radius: 45, category: "learning", skill: "SVG" }, { radius: 45, category: "competent in", skill: "Ruby" }, { radius: 45, category: "competent in", skill: "JavaScript" },
    ...
    { radius: 45, category: "competent in", skill: "Ajax" }, { radius: 45, category: "competent in", skill: "Git" },
    { radius: 45, category: "competent in", skill: "Rails" }, { radius: 45, category: "competent in", skill: "Sinatra" },
    ...
    { radius: 45, category: "competent in", skill: "HiveSQL" }, { radius: 45, category: "competent in", skill: "Heroku" }, { radius: 45, category: "competent in", skill: "Node" },
    { radius: 45, category: "competent in", skill: "Command Line" }, { radius: 45, category: "learning", skill: "D3js" }, { radius: 45, category: "competent in", skill: "Express" }, { radius: 45, category: "learning", skill: "MongoDB" }, { radius: 45, category: "learning", skill: "MongoLab" },
    { radius: 45, category: "learning", skill: "Vue JS" }, { radius: 45, category: "competent in", skill: "AngularJS" }, { radius: 45, category: "learning", skill: "Docker" }, { radius: 45, category: "competent in", skill: "Splunk" }
];
